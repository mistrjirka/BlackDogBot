...
import { ensureDefaultDatabaseAsync } from "./helpers/litesql.js";
...
import { autoSetupSkillsAsync } from "./helpers/skill-auto-setup.js";
import { registerRunTimedExecutor } from "./executors/run-timed-port.js";
...
async function mainAsync(): Promise<void> {
  ...
  await autoSetupSkillsAsync(config, logger, notifyAllChannelsAsync);
  ...
  if (config.scheduler.enabled) {
    ...
    registerRunTimedExecutor(cronAgent.executeTaskAsync.bind(cronAgent));
