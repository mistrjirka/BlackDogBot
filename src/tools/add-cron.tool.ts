 ...
 * Injected into the verifier prompt so the LLM knows what each tool does and
 * does not reject instructions that use well-known tools (e.g. send_message)
 * as if they were ambiguous unresolved destinations.
 */
